      ...
      <div className="flex h-full p-4 bg-gray-100 rounded-lg shadow-md border-4 border-gray-400">
        ...
        {!showAtOnce && (
          <div className="flex flex-col items-center">
            <div className="bg-gray-100 text-xl font-bold text-gray-900 py-1 px-3 rounded-lg shadow-sm">
        ...
        {showAtOnce ? (
          <>
            <div className="bg-gray-100 py-10 px-6 md:py-16 md:px-10 rounded-lg shadow-lg w-full max-w-xl text-center">
              ...
              <p className="text-lg md:text-xl text-gray-700">{questions[currentQuestionIndex]?.questionText}</p>
            </div>
          ...
          questions.map((question, index) => (
            <div
              key={index}
              className="bg-gray-100 py-10 px-6 md:py-16 md:px-10 rounded-lg shadow-lg w-full max-w-xl text-center"
            >
              <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-5 text-gray-800">
